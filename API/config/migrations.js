...
async function runMigrations() {
  ...
  // devices (MTProto user accounts)
  await db.execute(`CREATE TABLE IF NOT EXISTS devices (
    id INT AUTO_INCREMENT PRIMARY KEY,
    phone VARCHAR(32) NOT NULL,
    username VARCHAR(255) NULL,
    display_name VARCHAR(255) NULL,
    status VARCHAR(32) NOT NULL DEFAULT 'pending', -- pending | active | inactive | revoked
  ...
  // device_sessions (encrypted session blobs)
  await db.execute(`CREATE TABLE IF NOT EXISTS device_sessions (
    id INT AUTO_INCREMENT PRIMARY KEY,
    device_id INT NOT NULL,
    session_data LONGTEXT NULL, -- encrypted base64
  ...
  // device_events (audit/events)
  await db.execute(`CREATE TABLE IF NOT EXISTS device_events (
    id INT AUTO_INCREMENT PRIMARY KEY,
    device_id INT NOT NULL,
